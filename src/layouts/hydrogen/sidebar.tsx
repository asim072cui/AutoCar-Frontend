...
export default function Sidebar({ className }: { className?: string }) {
  ...
  return (
    //what is the issue of hanburger icon is clicked but not opening the sidebar? and how can fix this the main layout file are in layout folder hydrogen layout.tsx and header.tsx  and sidebar.tsx
    <aside
      className={cn(
        ...
        >
           <div className="flex-shrink-0">
            <img
              ...
              className="cursor-pointer w-28 lg:w-40 bg-gray-600 rounded-lg"
              src="/image/Logo.png"
              alt="Logo"
            />
          </div>
