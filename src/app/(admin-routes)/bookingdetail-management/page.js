...
const BookingDetailManagement = () => {
  ...
  const rentBookings = bookings.filter((b) => b.bookingType === "rent").length;
  const buyBookings = bookings.filter((b) => b.bookingType === "buy").length;
  const pendingBookings = bookings.filter((b) => b.status === "Pending").length;
  const ApproveBookings = bookings.filter((b) =>  b.status === "Approved").length;
  ...
  const filteredBookings = bookings.filter((booking) => {
    ...
    if (booking.bookingType !== "rent") return false;
...
const handleStatusChange = async (bookingId, newStatus) => {
  ...
  return (
    <HydrogenLayout>
      <div className="min-h-screen p-6">
        ...
        {/* Statistics Cards */}
       <div className="flex gap-4 mb-6 mt-2 overflow-x-auto no-scrollbar ">
  <div className="bg-white rounded-lg shadow p-5 border-l-4 border-blue-500 min-w-[260px] flex-shrink-0">
   ...
   <div className="bg-white rounded-lg shadow p-5 border-l-4 border-purple-500 min-w-[260px] flex-shrink-0">
    <div className="flex items-center justify-between">
      <div>
        <p className="text-gray-500 text-sm font-medium">Rent Bookings</p>
        <p className="text-3xl font-bold text-gray-800 mt-1">
          {rentBookings}
        </p>
      </div>
  ...
  <div className="bg-white rounded-lg shadow p-5 border-l-4 border-yellow-500 min-w-[260px] flex-shrink-0">
    <div className="flex items-center justify-between">
      <div>
  ...
  <div className="bg-white rounded-lg shadow p-5 border-l-4 border-green-500 min-w-[260px] flex-shrink-0">
    <div className="flex items-center justify-between">
      <div>
                  ...
                  <td className="px-12 py-4 w-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-center">
                          <div className="text-2xl whitespace-nowrap font-bold text-blue-600">
                            {booking.rentDays}
                          </div>
                          <div className="text-xs text-gray-500">days</div>
                          {booking.car && (
                            <div className="text-xs font-semibold whitespace-nowrap text-gray-700 mt-1">
                              Total: ${booking.car.price * booking.rentDays}
                            </div>
                          )}
                        </div>
                      </td>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="text-lg font-bold text-gray-800">Rental Details</h3>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white rounded-lg p-4 shadow-sm text-center">
                          <p className="text-xs text-gray-500 mb-1">Rental Days</p>
                          <p className="text-3xl font-bold text-green-600">
                            {selectedBooking.rentDays}
                          </p>
                      ...
                      <div className="mt-4 bg-white rounded-lg p-4 shadow-sm">
                        <div className="flex items-center justify-between">
                          ...
                          <p className="text-2xl font-bold text-green-600">
                            ${selectedBooking.car ? selectedBooking.car.price * selectedBooking.rentDays : 0}
                          </p>
                        </div>
                      </div>
                    </div>
...
export default BookingDetailManagement;
